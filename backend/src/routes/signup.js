...
// Body: { name, email, phone, accountType, referralCode, terms }
router.post('/', async (req, res) => {
    const { name, email, phone, accountType, referralCode, terms } = req.body;
    if (!name || !email || !phone || !accountType || terms !== true) {
